...
@section('css')
  ...
  <link rel="stylesheet" href="{{ asset('backend/assets/vendor/libs/jquery/jquery-ui.css')}}">
@endsection
@section('content')
        ...
        <div class="card">
            <div class="card-header flex-column flex-md-row">               
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                  <div class="dt-buttons btn-group flex-wrap">
                    ...
                    <a href="{{ route('admin.categories.create') }}" class="btn btn-secondary create-new btn-primary waves-effect waves-light" tabindex="0" aria-controls="DataTables_Table_0" type="button">
                      <span>
                ...
                <div class="head-label">
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <select class="form-select form-select-sm select2" id="filter_menu" name="menu_item" aria-label="Default select example">
                        <option value="">Menu Search</option>
            ...
            <div class="table-responsive text-nowrap">
              <table class="table table-responsive" id="dataTable">
                ...
                <tbody class="table-border-bottom-0" id="tableBodyContents" style="cursor: all-scroll !important;">
...
<script src="{{ asset('backend/assets/vendor/libs/jquery/jquery-ui.min.js')}}"></script>

<x-admin.datatable.category-datatable />
