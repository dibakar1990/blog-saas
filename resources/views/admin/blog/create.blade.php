        ...
        <div class="row fv-plugins-icon-container">
            <div class="col-md-12">
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                        <form id="formNewsCreate" method="post" action="{{ route('admin.news.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mt-1 g-5">
                                <div class="col-md-12 form-floating form-floating-outline mb-6">
                                    <input type="text" class="form-control @error('news_title') is-invalid @enderror" id="name" name="news_title" placeholder="News title">
                                ...
                                <div class="col-md-4 form-floating form-floating-outline mb-6">
                                    ...
                                    <div class="form-check form-check-inline mt-4">
                                        <input class="form-check-input" type="radio" name="popular_news" id="inlineRadio1" value="1">
                                        <label class="form-check-label" for="inlineRadio1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline mt-4">
                                        <input class="form-check-input" type="radio" name="popular_news" id="inlineRadio1" value="0">
                                ...
                                <div class="col-md-4 form-floating form-floating-outline mb-6">
                                    ...
                                    <div class="form-check form-check-inline mt-4">
                                        <input class="form-check-input" type="radio" name="latest_news" id="latest_news_yes" value="1">
                                        <label class="form-check-label" for="latest_news_yes">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline mt-4">
                                        <input class="form-check-input" type="radio" name="latest_news" id="latest_news_no" value="0">
                                        <label class="form-check-label" for="latest_news_no">No</label>
                                    </div>
                                </div>
                                
                                <div class="col-md-12 form-floating form-floating-outline mb-6">
                                    <textarea class="form-control summernote" rows="5" name="description" id="description"></textarea>
...
<script src="{{ asset('backend/assets/js/pages/blog/create.js') }}"></script>
