            ...
            <div class="card-header flex-column flex-md-row">               
                <div class="dt-action-buttons text-end pt-3 pt-md-0">
                  <div class="dt-buttons btn-group flex-wrap">
                    ...
                    <a href="{{ route('admin.news.create') }}" class="btn btn-secondary create-new btn-primary waves-effect waves-light" tabindex="0" aria-controls="DataTables_Table_0" type="button">
                      <span>
                ...
                <div class="head-label">
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <select class="form-select form-select-sm select2" id="filter_latest" name="latest_news" aria-label="Default select example">
                    ...
                    <div class="col-md-2">
                        <select class="form-select form-select-sm select2" id="filter_popular" name="popular_news" aria-label="Default select example">
                          <option value="">Popular News</option>
                          <option value="1">Yes</option>
                          <option value="0">No</option>
                        </select>
                      </div>
...
<x-admin.datatable.news-datatable />
