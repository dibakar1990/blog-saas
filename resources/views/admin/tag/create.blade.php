        ...
        <div class="row fv-plugins-icon-container">
            <div class="col-md-12">
                <div class="card mb-6">
                    ...
                    <div class="card-body">
                        <form id="formTag" method="post" action="{{ route('admin.tags.store')}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row mt-1 g-5">
                                <div class="col-md-6 form-floating form-floating-outline mb-6">
                                    <input type="text" class="form-control @error('tag_name') is-invalid @enderror" id="name" name="tag_name" placeholder="Tag Name">
